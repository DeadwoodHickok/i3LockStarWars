...
This is a fork of the  i3lock bash script that takes a screenshot of the desktop, blurs the background and adds a lock icon and text. This fork includes a Star Wars quote generator that displays a random Sith quote when the screen is dark, and a jedi one when it is light.
